...
namespace NUnit_Auto_2022
{
    class AuthTests
    {
        ...
        public void Test08()
        {
            driver.Navigate().GoToUrl("trebuie sa pun url-ul");

            var hoverButton = driver.FindElement(By.CssSelector("puntem hover button"));
            Actions actions = new Actions(driver);
            actions.MoveToElement(hoverButton).Build().Perform();//puntem inlantui mai multe actiuni inainte de build si perform
...
/*            foreach (var item in allItems)
        ...
        public void Test11()
        {
            driver.Navigate().GoToUrl("numele url-ului");

            var iframe = driver.FindElement(By.CssSelector("punem selectorul"));
